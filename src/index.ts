...
async function main() {
  ...
  registerCommands(registry, "unfollow", middlewareLoggedIn(handlerUnfollow));
  registerCommands(registry, "browse", middlewareLoggedIn(handlerBrowse));
